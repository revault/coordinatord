use crate::coordinatord::SigCache;
...
pub fn process_stakeholder_message(
    ...
    match serde_json::from_slice::<FromStakeholder>(&msg)? {
        ...
        FromStakeholder::GetSigs { id } => Ok(Some(serde_json::to_vec(&Sigs {
...
mod tests {
    ...
    pub fn getsigs_sanity_checks() {
        ...
        let id = Txid::from_hex("264595a4ace1865dfa442bb923320b8f00413711655165ac13a470db2c5384c0")
            .unwrap();
        let plaintext_sig = FromStakeholder::Sig {
            id,
            pubkey,
        ...
        let encrypted_signature_1 = FromStakeholder::Sig {
            id: id2,
            pubkey,
        ...
        let encrypted_signature_2 = FromStakeholder::Sig {
            id: id2,
            pubkey,
        ...
        let getsigs_1 = serde_json::to_vec(&FromStakeholder::GetSigs { id }).unwrap();
        ...
        let getsigs_2 = serde_json::to_vec(&FromStakeholder::GetSigs { id: id2 }).unwrap();
        ...
        assert_eq!(
            serde_json::from_slice::<Sigs>(
                &process_stakeholder_message(&sigcache, getsigs_2)
                    .unwrap()
                    .unwrap(),
            )
            .unwrap(),
